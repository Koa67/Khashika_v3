...
export default function UniversPage() {
  return (
    <div className="bg-white">
      {/* Hero */}
      <section className="bg-[#2D2926] text-white py-8">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-[#EAB615] text-[10px] uppercase tracking-widest mb-1">Bienvenue dans</p>
          <h1 className="text-xl font-bold mb-1">L&apos;Univers Khashika</h1>
      ...
      <section className="py-8">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid md:grid-cols-[1fr,200px] gap-4 items-start">
            <div>
              <h2 className="text-sm font-bold text-[#2D2926] mb-2">Le bijou indien, un art ancestral</h2>
              <div className="space-y-2 text-[11px] text-[#2D2926]/80 leading-relaxed">
                <p>
      ...
      <section className="py-8 bg-[#FAF9F7]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid md:grid-cols-[200px,1fr] gap-4 items-start">
            ...
            <div>
              <h2 className="text-sm font-bold text-[#2D2926] mb-2">Pierres précieuses et significations</h2>
              <div className="space-y-2 text-[11px] text-[#2D2926]/80 leading-relaxed">
                <p>
              ...
              <Link href="/guide-pierres" className="inline-flex items-center mt-2 text-[11px] text-[#EAB615] font-medium hover:underline">
      ...
      <section className="py-8">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-sm font-bold text-[#2D2926] mb-4 text-center">Savoir-faire artisanal</h2>
          <div className="grid grid-cols-3 gap-3">
            {/* Minakari */}
            <div className="bg-[#FAF9F7] p-2 border border-[#EAB615]/20">
              <div className="relative aspect-square w-20 mx-auto mb-2 bg-white">
                <Image src="/images/univers/minakari.jpg" alt="Technique Minakari" fill className="object-contain" sizes="80px" />
              </div>
              <h3 className="text-[11px] font-bold text-[#2D2926] text-center">Minakari</h3>
              <p className="text-[10px] text-[#2D2926]/70 text-center mt-1">
            ...
            {/* Kundan */}
            <div className="bg-[#FAF9F7] p-2 border border-[#EAB615]/20">
              <div className="aspect-square w-20 mx-auto mb-2 bg-white flex items-center justify-center text-3xl">💎</div>
              <h3 className="text-[11px] font-bold text-[#2D2926] text-center">Kundan</h3>
              <p className="text-[10px] text-[#2D2926]/70 text-center mt-1">
            ...
            <div className="bg-[#FAF9F7] p-2 border border-[#EAB615]/20">
              <div className="aspect-square w-20 mx-auto mb-2 bg-white flex items-center justify-center text-3xl">✨</div>
              <h3 className="text-[11px] font-bold text-[#2D2926] text-center">Filigrane d&apos;Orissa</h3>
              <p className="text-[10px] text-[#2D2926]/70 text-center mt-1">
      ...
      <section className="py-6 bg-[#2D2926] text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <p className="text-[#EAB615] text-[10px] mb-1">Namasté</p>
          <h2 className="text-sm font-bold mb-2">Notre histoire</h2>
          ...
          <Link href="/notre-histoire" className="inline-flex items-center text-[11px] text-[#EAB615] font-medium hover:underline">
      ...
      <section className="py-8 text-center">
        <div className="max-w-2xl mx-auto px-4">
          <h2 className="text-sm font-bold text-[#2D2926] mb-2">Découvrez nos créations</h2>
          <p className="text-[11px] text-[#2D2926]/70 mb-4">
          ...
          <Link href="/shop" className="inline-flex items-center justify-center px-5 py-2 bg-[#2D2926] text-white text-[11px] font-medium hover:bg-[#2D2926]/90 transition-colors">
