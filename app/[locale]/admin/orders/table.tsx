    ...
    <div className="min-h-screen bg-background pt-32 pb-20">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between mb-8">
          <h1 className="font-serif text-4xl text-[#1a1a1a]">{t('orders')}</h1>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2596be]"
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2596be]"
              >
                ...
                <tr key={order.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <span className="font-medium text-[#1a1a1a]">{order.orderNumber}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      <div className="text-sm font-medium text-[#1a1a1a]">{order.customerName}</div>
                    ...
                    <div className="flex gap-2">
                      {order.status === 'paid' && (
                        <button
                          ...
                          className="text-[#2596be] hover:text-[#1e7a9a] font-medium"
                        >
                          {t('markAsShipped')}
                        </button>
                      )}
                      <button className="text-gray-600 hover:text-[#1a1a1a] font-medium">
                        {t('viewDetails')}
                      </button>
                    </div>
                  </td>
