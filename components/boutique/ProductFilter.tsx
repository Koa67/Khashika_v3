    ...
    <div className="w-full">
      ...
      <div className="md:hidden mb-4">
        <button
          ...
          className="w-full flex items-center justify-between p-4 bg-white border border-[#EAB615]/40 rounded-none hover:border-[#EAB615] transition-colors"
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              {hasActiveFilters && (
                <button
                  onClick={handleReset}
                  className="text-sm text-foreground/60 hover:text-gold-fusion transition-colors flex items-center gap-1"
