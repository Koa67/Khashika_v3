  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 text-[#2D2926] hover:text-gold-fusion transition-colors"
        ...
        <>
          ...
          <div className="absolute right-0 mt-2 w-32 bg-[#FAF9F7] border border-[#EAB615]/40 rounded-none shadow-[0_4px_12px_rgba(240,193,29,0.25)] z-20">
            <button
              ...
              className={`w-full text-left px-4 py-2 text-sm hover:bg-white transition-colors text-[#2D2926] ${
